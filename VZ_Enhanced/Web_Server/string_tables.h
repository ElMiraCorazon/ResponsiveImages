...
#define ST_Allow_Keep_Alive_requests		server_string_table[ 2 ]
#define ST_Certificate_file_				server_string_table[ 3 ]
#define ST_Document_root_directory_			server_string_table[ 4 ]
#define ST_Enable_SSL___TLS_				server_string_table[ 5 ]
#define ST_Enable_web_server_				server_string_table[ 6 ]
#define ST_Hostname___IPv6_address_			server_string_table[ 7 ]
#define ST_IPv4_address_					server_string_table[ 8 ]
#define ST_Key_file_						server_string_table[ 9 ]
#define ST_Load_PKCS_NUM12_File				server_string_table[ 10 ]
#define ST_Load_Private_Key_File			server_string_table[ 11 ]
#define ST_Load_X_509_Certificate_File		server_string_table[ 12 ]
#define ST_Password_						server_string_table[ 13 ]
#define ST_PKCS_NUM12_						server_string_table[ 14 ]
#define ST_PKCS_NUM12_file_					server_string_table[ 15 ]
#define ST_PKCS_NUM12_password_				server_string_table[ 16 ]
#define ST_Port_							server_string_table[ 17 ]
#define ST_Public___Private_key_pair_		server_string_table[ 18 ]
#define ST_Require_authentication_			server_string_table[ 19 ]
#define ST_Resource_cache_size__bytes__		server_string_table[ 20 ]
#define ST_Select_the_root_directory		server_string_table[ 21 ]
#define ST_SSL_2_0							server_string_table[ 22 ]
#define ST_SSL_3_0							server_string_table[ 23 ]
#define ST_SSL___TLS_version_				server_string_table[ 24 ]
#define ST_Start_web_server_upon_startup	server_string_table[ 25 ]
#define ST_Thread_pool_count_				server_string_table[ 26 ]
#define ST_TLS_1_0							server_string_table[ 27 ]
#define ST_TLS_1_1							server_string_table[ 28 ]
#define ST_TLS_1_2							server_string_table[ 29 ]
#define ST_Username_						server_string_table[ 30 ]
#define ST_Verify_WebSocket_origin			server_string_table[ 31 ]
